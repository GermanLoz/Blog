...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Marvel:wght@700&display=swap" rel="stylesheet">        <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo e(asset('static/css/app.css')); ?>"/>
        <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        ...
        <header>
            <nav class="nav-bar">
                <ul class="nav-bar-ul">
                    ...
                    <li class="nav-bar-ul-li">
                        <a class="nav-link" href=<?php echo e(route('programing')); ?>>Programacion</a>
                    </li>
                    <li class="nav-bar-ul-li">
                        <a class="nav-link" href=<?php echo e(route('physics')); ?>>Fisica</a>
                    </li>
                    <li class="nav-bar-ul-li">
                        <a class="nav-link" href=<?php echo e(route('summaries')); ?>>Resumenes de libros</a>
                    </li>
                </ul>
            </nav>
        </header>
    </div><?php /**PATH /var/www/html/resources/views/components/navbar.blade.php ENDPATH**/ ?>